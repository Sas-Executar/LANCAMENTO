...
Adotar cinco superfícies: **Discover**, **Collections**, **Solution Detail**, **Learn** e **Onboarding**. Cards são a unidade primária de descoberta. Start e Download são ações semanticamente distintas.
